"""
NarrativeQA Benchmark â€” Baseline vs Graph no markdown vs Graph with markdown.
Dataset: deepmind/narrativeqa test split â€” 500 QA pairs (seed=42).
...
# Hard caps â€” prevent OOM on very large books
...
def load_narrativeqa() -> list:
    ...
    print(f"[Data] Loading NarrativeQA test split â€” {'MINI' if MINI else 'full'} mode...")
...
def build_graphs(ollama: OllamaManager):
    print("\n" + "=" * 50)
    print(">>> GRAPH BUILDING â€” Qwen 7B (NARRATIVEQA) <<<")
    print("=" * 50)
...
def ingest_baseline(ollama: OllamaManager):
    print("\n" + "=" * 50)
    print(">>> INGESTION â€” Baseline (NARRATIVEQA) <<<")
    print("=" * 50)
...
def ingest_graphnomd(ollama: OllamaManager):
    print("\n" + "=" * 50)
    print(">>> INGESTION â€” Graph no markdown (NARRATIVEQA) <<<")
    print("=" * 50)
...
def ingest_graphmd(ollama: OllamaManager):
    print("\n" + "=" * 50)
    print(">>> INGESTION â€” Graph with markdown (NARRATIVEQA) <<<")
    print("=" * 50)
...
def print_comparison(scores: dict):
    ...
    print("\n" + "=" * 72)
    print(f"  NARRATIVEQA RESULTS ({'MINI â€” ' + str(SAMPLE_SIZE) + ' samples' if MINI else str(SAMPLE_SIZE) + ' samples'})")
    print("=" * 72)
